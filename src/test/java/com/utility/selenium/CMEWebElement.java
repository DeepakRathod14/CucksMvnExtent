...
public class CMEWebElement{
	...
	public void click(By by) {
		...
		catch (Exception e)
		{
			...
			CMEAssert.assertTrue(false, "Fail to click Element on windiw : "+by+" On Page : " + e.getMessage());
		}
	...
	public void clear(By by) {
		...
		{
			logger.info(e.getMessage());
			CMEAssert.assertTrue(false, "Fail to Clear Element on windiw : "+by+" On Page : " + e.getMessage());
		}
	...
	public void sendKeys(By by, String keysToSend) {
		...
		{
			logger.info(e.getMessage());
			CMEAssert.assertTrue(false, "Fail to SendKeys Element on windiw : "+by+" On Page : " + e.getMessage());
		}
	...
	public void sendKeysWait(By by, String keysToSend, boolean cleanElement) {
		...
		{
			logger.info(e.getMessage());
			CMEAssert.assertTrue(false, "Fail to SendKeysWait Element on windiw : "+by+" On Page : " + e.getMessage());
		}
	...
	public String getText(By by) {
		...
		{
			logger.info(e.getMessage());
			CMEAssert.assertTrue(false, "Fail to GetText Element on windiw : "+by+" On Page : " + e.getMessage());
		}
		return null;
	}
	...
	public String getAttribute(By by, String attribute) {
		...
		{
			logger.info(e.getMessage());
			CMEAssert.assertTrue(false, "Fail to Get Attribute Element on windiw : "+by+" On Page : " + e.getMessage());
		}
		return null;
	}
	...
	public boolean isSelected(By by) {
		...
		{
			logger.info(e.getMessage());
			CMEAssert.assertTrue(false, "Fail to Select Option from Element on windiw : "+by+" On Page : " + e.getMessage());
		}
		return false;
	}
	...
	public boolean isEnabled(By by) {
		...
		{
			logger.info(e.getMessage());
			CMEAssert.assertTrue(false, "Fail to verify Element is Enalble or not on windiw : "+by+" On Page : " + e.getMessage());
		}
		return false;
	}
	...
	public boolean isDisplayed(By by) {
		...
		{
			logger.info(e.getMessage());
			CMEAssert.assertTrue(false, "Fail to verify Element is display or not on windiw : "+by+" On Page : " + e.getMessage());
		}
		return false;
	}
	...
	public boolean isClickable(By by) {
		...
		{
			logger.info(e.getMessage());
			CMEAssert.assertTrue(false, "Fail to verify Element is Clickable or not on windiw : "+by+" On Page : " + e.getMessage());
		}
		return false;
	}
	...
	public void dragAndDrop(By source, By target) {
		...
		{
			logger.info(e.getMessage());
			CMEAssert.assertTrue(false, "Fail to drag and drop from : " + source + " to : " + target + " on page: " + e.getMessage());
		}
	}
	...
	public String getPopupMsgAndAccept() {
		...
		{
			CMEAssert.assertTrue(false, "Fail to Handle Alert on windiw : " + e.getMessage());
		}
		catch (Exception e)
		{
			logger.info(e.getMessage());
	...
	public void scrollToElement(By by) {
		...
		{
			CMEAssert.assertTrue(false, "Fail to ScrollToElement on windiw : "+by+" On Page : " + e.getMessage());
		}
		catch (Exception e)
		{
			logger.info(e.getMessage());
	...
	public String getCssValue(By by, String propertyName) {
		...
		{
			CMEAssert.assertTrue(false, "Fail to get CSS value from : " + by + " on page : " + e.getMessage());
		}
		catch (Exception e)
		{
			logger.info(e.getMessage());
	...
	public void selectOptionFromDropDown(By by, String option) {
		...
		{
			CMEAssert.assertTrue(false, "Fail to find drop down box to select option : " + by + " on page : " + e.getMessage());
		}
		catch (Exception e)
		{
			logger.info(e.getMessage());
	...
	public List<String> getValuesFromDropDown(By by) {
		...
		{
			CMEAssert.assertTrue(false, "Fail to fetch value from drop down box on page : " + e.getMessage());
		}
		catch (Exception e)
		{
			logger.info(e.getMessage());
